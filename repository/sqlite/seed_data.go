...
var seedData = []domain.Ride{
	// ---------------------------------------------------------------- Ekstrem
	{
		...
		Emoji:       "🎢", Price: 75000, DurationMin: 4, MinHeightCm: 140, ThrillLevel: 5, DailyQuota: 400,
	},
	{
		...
		Emoji:       "⛓️", Price: 80000, DurationMin: 4, MinHeightCm: 140, ThrillLevel: 5, DailyQuota: 350,
	},
	{
		...
		Emoji:       "🗼", Price: 65000, DurationMin: 2, MinHeightCm: 130, ThrillLevel: 5, DailyQuota: 300,
	},
	{
		...
		Emoji:       "🌪️", Price: 55000, DurationMin: 3, MinHeightCm: 130, ThrillLevel: 4, DailyQuota: 350,
	},
	{
		...
		Emoji:       "🏴‍☠️", Price: 45000, DurationMin: 5, MinHeightCm: 120, ThrillLevel: 4, DailyQuota: 500,
	},
	{
		...
		Emoji:       "🎠", Price: 50000, DurationMin: 4, MinHeightCm: 120, ThrillLevel: 4, DailyQuota: 400,
	},
	...
	// --------------------------------------------------------------- Keluarga
	{
		...
		Emoji:       "🎡", Price: 40000, DurationMin: 12, MinHeightCm: 0, ThrillLevel: 1, DailyQuota: 600,
	},
	{
		...
		Emoji:       "🎠", Price: 30000, DurationMin: 5, MinHeightCm: 0, ThrillLevel: 1, DailyQuota: 700,
	},
	{
		...
		Emoji:       "🚗", Price: 35000, DurationMin: 6, MinHeightCm: 100, ThrillLevel: 2, DailyQuota: 500,
	},
	{
		...
		Emoji:       "🚂", Price: 25000, DurationMin: 15, MinHeightCm: 0, ThrillLevel: 1, DailyQuota: 800,
	},
	{
		...
		Emoji:       "🦢", Price: 35000, DurationMin: 20, MinHeightCm: 0, ThrillLevel: 1, DailyQuota: 300,
	},
	{
		...
		Emoji:       "🪞", Price: 30000, DurationMin: 15, MinHeightCm: 0, ThrillLevel: 2, DailyQuota: 400,
	},
	...
	// ------------------------------------------------------------------- Anak
	{
		...
		Emoji:       "🏰", Price: 25000, DurationMin: 20, MinHeightCm: 0, ThrillLevel: 1, DailyQuota: 500,
	},
	{
		...
		Emoji:       "🔴", Price: 25000, DurationMin: 30, MinHeightCm: 0, ThrillLevel: 1, DailyQuota: 500,
	},
	{
		...
		Emoji:       "🐴", Price: 20000, DurationMin: 5, MinHeightCm: 0, ThrillLevel: 1, DailyQuota: 400,
	},
	{
		...
		Emoji:       "🚞", Price: 20000, DurationMin: 8, MinHeightCm: 0, ThrillLevel: 1, DailyQuota: 450,
	},
	...
	// ------------------------------------------------------------ Wahana Air
	{
		...
		Emoji:       "🛝", Price: 60000, DurationMin: 2, MinHeightCm: 120, ThrillLevel: 4, DailyQuota: 500,
	},
	{
		...
		Emoji:       "🌊", Price: 55000, DurationMin: 60, MinHeightCm: 0, ThrillLevel: 3, DailyQuota: 800,
	},
	{
		...
		Emoji:       "🛶", Price: 65000, DurationMin: 6, MinHeightCm: 110, ThrillLevel: 4, DailyQuota: 450,
	},
	{
		...
		Emoji:       "🏞️", Price: 45000, DurationMin: 30, MinHeightCm: 0, ThrillLevel: 1, DailyQuota: 700,
	},
	{
		...
		Emoji:       "🪣", Price: 40000, DurationMin: 30, MinHeightCm: 0, ThrillLevel: 2, DailyQuota: 600,
	},
	...
	// ----------------------------------------------------------- Petualangan
	{
		...
		Emoji:       "🪂", Price: 70000, DurationMin: 3, MinHeightCm: 120, ThrillLevel: 4, DailyQuota: 250,
	},
	{
		...
		Emoji:       "🌉", Price: 50000, DurationMin: 10, MinHeightCm: 110, ThrillLevel: 3, DailyQuota: 300,
	},
	{
		...
		Emoji:       "🧗", Price: 55000, DurationMin: 15, MinHeightCm: 110, ThrillLevel: 3, DailyQuota: 200,
	},
	{
		...
		Emoji:       "🏍️", Price: 90000, DurationMin: 15, MinHeightCm: 130, ThrillLevel: 4, DailyQuota: 150,
	},
	{
		...
		Emoji:       "🔫", Price: 85000, DurationMin: 30, MinHeightCm: 130, ThrillLevel: 3, DailyQuota: 120,
	},
	{
		...
		Emoji:       "🪢", Price: 60000, DurationMin: 20, MinHeightCm: 120, ThrillLevel: 3, DailyQuota: 200,
	},
	...
	// ----------------------------------------------------------------- Indoor
	{
		...
		Emoji:       "👻", Price: 55000, DurationMin: 12, MinHeightCm: 100, ThrillLevel: 4, DailyQuota: 400,
	},
	{
		...
		Emoji:       "🎬", Price: 50000, DurationMin: 15, MinHeightCm: 0, ThrillLevel: 2, DailyQuota: 500,
	},
	{
		...
		Emoji:       "🥽", Price: 65000, DurationMin: 15, MinHeightCm: 100, ThrillLevel: 3, DailyQuota: 300,
	},
	{
		...
		Emoji:       "🕹️", Price: 40000, DurationMin: 30, MinHeightCm: 0, ThrillLevel: 1, DailyQuota: 600,
	},
	{
		...
		Emoji:       "🔭", Price: 35000, DurationMin: 25, MinHeightCm: 0, ThrillLevel: 1, DailyQuota: 350,
	},
}
