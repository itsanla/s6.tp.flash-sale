...
func NewFlashSaleUsecase(repo domain.StockRepository, pub domain.Publisher, ttl time.Duration) *FlashSaleUsecase {
	return &FlashSaleUsecase{repo: repo, pub: pub, ttl: ttl}
}
